...
// An array of objects. Should feature a cancel token as well as a promisefn to handle
...
axios.interceptors.response.use((response) => {
  ...
  const FAKE_CANCELLATION_RESPONSE = {
    "response": {
      "data": {
  ...
  if (typeof err !== "undefined") {
    ...
    if (err.response) {
      ...
      return Promise.reject(FAKE_CANCELLATION_RESPONSE)
